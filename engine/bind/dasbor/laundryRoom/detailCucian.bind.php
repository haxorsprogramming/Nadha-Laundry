    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-12">
            <div class='card card-primary' style="border-radius:3px; padding:12px;">
                ...
                <table class="">
                    <tr>
                        <td>Kode Registrasi Cucian</td>
                        <td>: <span id='txtKdRegistrasi' style="font-weight: bold;"><?=$kd; ?></span></td>
                    </tr>
                    <tr>
                        <td>Nama Pelanggan</td>
                        <td>: <span id='txtNamaPelanggan'><?=$namaPelanggan; ?></span></td>
                    </tr>
                    <tr>
                        <td>Waktu Masuk</td>
                        <td>: <?=$waktuMasuk; ?></td>
                    ...
                    <tr>
                        <td>Total Item</td>
                        <td>: <span id='txtJumlahItem'><?=$jlhItem; ?></span></td>
                    </tr>
                    <tr>
                        <td>Total Harga</td>
                        <td>: Rp. <span id='txtTotalInt' style="display: none;"><?=$hargaAwal; ?></span><span
                                id='txtTotalView'><?=number_format($hargaAwal); ?></span></td>
                    </tr>
                </table>
                <div style="padding-top:12px;">
                    <a href='#!' class="btn btn-primary btn-icon icon-left" id='btnSetBayar' v-on:click='setBayar'
                        <?=$capBtnbayar; ?>><i class='fas fa-receipt'></i> Bayar</a>&nbsp;&nbsp;
                    <a href='#!' class="btn btn-primary btn-icon icon-left" id='btnSetSelesai'
                        v-on:click='setSelesaiAtc'><i class='fas fa-check-circle'></i> Set selesai</a>
                    <div>
            ...
            <table class="table table-bordered table-stripped" style="font-size: 15px;">
                ...
                <tbody>
                    <tr v-for='li in listItem'>
                        <td>{{li.teks}}</td>
                        <td>{{li.qt}} Kg</td>
                        <td>Rp. {{ Number(li.total).toLocaleString() }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
        <div class="col-lg-6 col-md-6 col-12" <?=$capTblTambahItem; ?>>
            ...
            <a href='#!' class="btn btn-primary btn-icon icon-left" v-on:click="tambahItem" id='btnTambahItem'><i
                    class='fas fa-plus-circle'></i> Tambah item</a>
        </div>
    </div>
</div>
